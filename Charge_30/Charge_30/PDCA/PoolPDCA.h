...
-(BOOL)AdjustPDCA:(NSString *) strName strSWName:(const char *)strSWName str_SWVersion:(const char *)str_SWVersion str_StationSN:(const char *)str_StationSN str_PDCAData:(NSString *)str_PDCAData ErrorFlag:(NSString *)flag Priority:(NSString *)priority startTime:(time_t)start
          endTime:(time_t)end;
-(BOOL)Bobcat_Check:(const char *)str_SN strSWName:(const char *)strSWName str_SWVersion:(const char *)str_SWVersion str_StationSN:(const char *)str_StationSN slot_Num:(long int)slot;
